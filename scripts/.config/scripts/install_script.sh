...
sudo apt -y install i3 kitty rofi thunar i3blocks wireless-tools picom stow nitrogen neovim zsh ripgrep tmux imagemagick snapd openjdk-11-jdk python3.12-venv | exit 
